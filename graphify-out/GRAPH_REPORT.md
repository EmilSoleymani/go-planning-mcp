...
- Stop Destinations Normalization
- Smoke Testing & Repo/CI Setup
- Package Metadata
- npm Scripts
- Service Guarantee Normalization
- Union Departures Normalization
...
1. `MetrolinxError` - 47 edges
2. `MetrolinxClient` - 43 edges
3. `toToolErrorResult()` - 35 edges
...
Cohesion: 0.07
Nodes (52): ADR-0001, MetrolinxError, MetrolinxErrorCode, toToolErrorResult(), MetrolinxClient, MetrolinxHttpClientOptions, RawEnvelope, SERVICE_GLANCE_SEGMENT (+44 more)
...
Cohesion: 0.07
Nodes (50): RawLineScheduleResponse, RawLineScheduleStop, RawLineScheduleTrip, RawNextServiceLine, RawNextServiceResponse, combine(), composeViaUnion(), fetchDirectOrComposed() (+42 more)

### Community 3 - "MCP Server Transports (stdio/http)"
Cohesion: 0.07
Nodes (19): client, handler, client, handleMcp(), httpServer, methodNotAllowed(), port, server (+11 more)

### Community 4 - "Line Listing & Ambiguity Resolution"
Cohesion: 0.05
Nodes (38): RawLineAllEntry, RawLineAllResponse, modesOf(), normalizeLine(), normalizeListLines(), fixture, Ambiguity, ambiguitySchema (+30 more)

### Community 5 - "Prompt & Tool Test Fixtures"
Cohesion: 0.12
Nodes (18): fixture, allFixture, engineFixture, fixture, fixture, fixture, fixture, stopAllFixture (+10 more)
...
Cohesion: 0.14
Nodes (17): RawGtfsVehiclePositionsResponse, RawServiceGlanceTrip, buildOccupancyMap(), buildStopNameMap(), lastSegment(), normalizeVehicle(), normalizeVehiclePositions(), glance (+9 more)
...
Cohesion: 0.12
Nodes (14): alertsFixture, destinationsFixture, exceptionsFixture, fixture, guaranteeFixture, journeyFixture, lineAllFixture, lineScheduleFixture (+6 more)
...
Cohesion: 0.26
Nodes (13): RawStopListEntry, matchesFilter(), matchTier(), normalizeSearchStops(), normalizeText(), resolveStopByName(), resolveStopCode(), scoredMatches() (+5 more)
...
### Community 20 - "Stop Destinations Normalization"
Cohesion: 0.20
Nodes (11): RawDestinationLine, RawStopDestinationsResponse, destinationStopName(), LINE_NAMES, normalizeStopDestinations(), fixture, Destination, destinationSchema (+3 more)
...
### Community 25 - "Union Departures Normalization"
Cohesion: 0.23
Nodes (11): RawUnionTrip, normalizeMode(), normalizeTrip(), normalizeUnionDepartures(), resolveStopCode(), getUnionDeparturesInputShape, UnionDeparture, unionDepartureSchema (+3 more)
...
Cohesion: 0.29
Nodes (6): RawStopAllResponse, RawUnionDeparturesResponse, fixture, stopAll, fixture, stopAll
...
Cohesion: 0.40
Nodes (4): RawServiceGlanceResponse, glanceFixture, positionsFixture, stopAllFixture
...
## Knowledge Gaps
- **260 isolated node(s):** `client`, `handler`, `name`, `version`, `description` (+255 more)
...
- **Should `Metrolinx API Client & Error Handling` be split into smaller, more focused modules?**
  _Cohesion score 0.07054871220604703 - nodes in this community are weakly interconnected._
